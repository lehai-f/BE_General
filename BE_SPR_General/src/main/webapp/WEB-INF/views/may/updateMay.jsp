	...
	<div class="row" id="body-row">
		...
		<div class="col p-4">
			...
			<div class="card shadow">
				...
				<div class="card-body">
					<form:form action="${pageContext.request.contextPath}/may/update" class="d-flex row justify-content-center"
						method="POST" modelAttribute="formUpdate">
						<div class="col-4">
							<div class="mb-3">
								<label for="" class="form-label">Mã Máy</label>
								<form:input type="hidden" class="form-control" placeholder=""
									aria-describedby="helpId" path="maMay" />
								<input type="text" name="displayMaKH" class="form-control"
									value="${maMay}" disabled="disabled" />
