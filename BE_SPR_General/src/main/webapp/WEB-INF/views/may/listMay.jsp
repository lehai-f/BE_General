			...
			<div class="card shadow">
				...
				<div class="card-body">
					...
					<table
						...
						<tbody>
							<c:forEach var="cp" items="${mayList}" varStatus="status">
								<tr>
									<td class="${cp.maMay} col-1">${cp.maMay}</td>
									<td class="vt${cp.maMay} col">${cp.viTri}</td>
									<td class="tt${cp.maMay} col">${cp.trangThai}</td>
