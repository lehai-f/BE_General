					...
					<form:form action="saveSDMay"
						...
						<div class="col-4">
							<div class="mb-3">
								...
								<form:select path="maMay" class="form-select">
									<form:option value="" disabled="true" selected="true">Chọn ID May</form:option>
									<form:options items="${listMay}" itemValue="maMay"
										itemLabel="maMay" />
								</form:select>
						...
						<div class="col-6">
							<div class="mb-3">
								<label for="" class="form-label">Thời Gian Sử Dụng</label>
